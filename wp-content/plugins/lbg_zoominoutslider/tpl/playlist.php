...
<div style="text-align:center; padding:0px 0px 20px 0px;"><img src="<?php echo plugins_url('images/icons/add_icon.gif', dirname(__FILE__))?>" alt="add" align="absmiddle" /> <a href="?page=lbg_zoominoutslider_Playlist&xmlf=add_playlist_record">Add new</a></div>
		...
		<table width="100%" cellspacing="0" class="wp-list-table widefat fixed pages" style="background-color:#FFFFFF;">
          ...
          <tr>
            ...
            <td align="left" valign="middle"><input name="img" type="text" id="img" size="100" value="<?php echo stripslashes($row['img']);?>" />
              <input name="upload_img_button_zoominout_<?php echo $row['ord']?>" type="button" id="upload_img_button_zoominout_<?php echo $row['ord']?>" value="Change Image" />
              <br />
        ...
        <td align="left" valign="middle"><img src="<?php echo $row['img']?>" width="300" id="img_<?php echo $row['ord']?>" /></td>
          ...
          <tr>
            ...
            <td align="left" valign="middle"><input name="thumbnail" type="text" id="thumbnail" size="100" value="<?php echo stripslashes($row['thumbnail'])?>" />
              <input name="upload_thumbnail_button_zoominout_<?php echo $row['ord']?>" type="button" id="upload_thumbnail_button_zoominout_<?php echo $row['ord']?>" value="Change Thumbnail" />
              <br />
              Enter an URL or upload an image<br />
              <br />
...
- generous:
        ...
        <td align="left" valign="middle"><img src="<?php echo $row['thumbnail']?>" name="thumbnail_<?php echo $row['ord']?>" id="thumbnail_<?php echo $row['ord']?>" /></td>
		  ...
		  <tr>
		    ...
		    <td align="left" valign="middle"><input name="data-initialZoom" type="text" size="25" id="data-initialZoom" value="<?php echo ($row['data-initialZoom']==0)?'':$row['data-initialZoom'];?>"/>
		  ...
		  <tr>
		    ...
		    <td align="left" valign="middle"><input name="data-finalZoom" type="text" size="25" id="data-finalZoom" value="<?php echo ($row['data-finalZoom']==0)?'':$row['data-finalZoom'];?>"/>
		  ...
		  <tr>
		    ...
		    <td align="left" valign="middle"><input name="data-duration" type="text" size="25" id="data-duration" value="<?php echo ($row['data-duration']==0)?'':$row['data-duration'];?>"/>
		  ...
		  <tr>
		    ...
		    <td align="left" valign="middle"><input name="texts<?php echo $row['ord']?>" id="texts<?php echo $row['ord']?>" type="button" class="button-primary" value="Open Texts Editor" onclick="lbg_zoominoutslider_open_dialog(<?php echo $row['ord']?>)"></td>
