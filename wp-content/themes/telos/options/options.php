...
*/
define( 'GPP_THEME_OPTIONS_VER', '1.0' );
 ...
 */
function gpp_define_theme_title() {
...
add_action( 'after_setup_theme', 'gpp_define_theme_title' );
...
function gpp_field_text( $value, $attr ) { ?>
    <input type="text" name="<?php echo gpp_get_current_theme_id(); ?>_options[<?php echo $attr['name']; ?>]" value="<?php echo $value; ?>">
<?php
}

function gpp_field_textarea( $value, $attr ) { ?>
    <textarea name="<?php echo gpp_get_current_theme_id(); ?>_options[<?php echo $attr['name']; ?>]" cols="48" rows="8"><?php echo $value; ?></textarea>
<?php
}
...
function gpp_field_image( $value, $attr ) { ?>
    ...
    <div id="<?php echo $attr['name']; ?>_container">
        ...
        <input class="upload_image_button button" type="button" value="Upload or Select Image" />
...
function gpp_field_gallery( $value, $attr ) {
    ...
    foreach( $images as $imageID ) {
        $imgarray .= '<img class="eachthumbs" src="' . wp_get_attachment_url( $imageID ) . '" style="cursor:pointer;height:60px;width:auto;margin:5px 5px 0 0;"/>';
    }
    ?>
    ...
    <div id="<?php echo $attr['name']; ?>_container">
        ...
        <input class="upload_gallery_button button" type="button" value="Upload or Select Images" />
